    ...
    Modernizr.on('webp', function(result) {
        ...
        if (result) {
            $elem.find('image').each(function() {
                var $this = $(this),
                    replaceStr, $dataSrc = $this.attr('data-src');
...
(function(w) {
    ...
    if ($('html').hasClass("index")) {
        ...
        ], purpleFrontPolys = [], purpleBackPolys = [], greenFrontPolys = [], greenBackPolys = [], yellowFrontPolys = [], yellowBackPolys = [], PSLogoPoints = [
...
(function(w) {
    ...
    function startTeleportAnim($elementTo, $elementFrom, animStartCallBack, animFinalCallBack, direction) {
        var Anim = new TimelineMax(),
            elementTo_Init, elementTo_F = {
                x: "0%",
                ease: Power1.easeOut
            },
            elementFrom_F, teleportAnim_Init, teleportAnimDIV_F;
        if (direction) {
            switch (direction) {
                case "reverse":
                    elementFrom_F = {
